...
internal static class Attack
{
    ...
    private static readonly Action<AttackerDamageHandler, bool> SetIsFriendlyFire =
        ReflectionHelper.PropertySetter<AttackerDamageHandler, bool>("IsFriendlyFire");

    private static readonly AccessTools.FieldRef<float> FfMultiplierRef =
        AccessTools.StaticFieldRefAccess<float>(AccessTools.Field(typeof(AttackerDamageHandler), "_ffMultiplier"));
    ...
    internal static void HandlerDamage(AttackerDamageHandler? handler, ReferenceHub? targetHub, bool allowed)
    {
        try
        {
            ...
            if (attacker.FriendlyFire)
                SetIsFriendlyFire(handler, false);
            ...
            SetIsFriendlyFire(handler, ev.FriendlyFire);
            ...
            if (!Server.FriendlyFire)
                ...
                handler.Damage *= FfMultiplierRef();
        }
        catch (Exception e)
        {
