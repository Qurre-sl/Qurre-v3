...
{
    private static readonly Stopwatch PreauthStopwatchValue =
        (Stopwatch)AccessTools.Field(typeof(IdleMode), "PreauthStopwatch").GetValue(null);
