...
public static class Extensions
{
    ...
    private static readonly AccessTools.FieldRef<ScpDamageHandler, byte> TranslationIdRef =
        AccessTools.FieldRefAccess<ScpDamageHandler, byte>("_translationId");
    ...
    public static DamageTypes GetDamageType(this DamageHandlerBase handler)
    {
        ...
        DamageTypes GetType()
        {
            return handler switch
            {
                ...
                ScpDamageHandler sr => ParseTranslation(TranslationIdRef(sr)),
    ...
    private static readonly MethodInfo GetRoleBaseMethod =
        AccessTools.Method(typeof(PlayerRoleManager), "GetRoleBase", new[] { typeof(RoleTypeId) });

    public static SpawnPoint GetSpawnPoint(this RoleTypeId role)
    {
        PlayerRoleBase? roleBase = (PlayerRoleBase)GetRoleBaseMethod.Invoke(Server.Host.ReferenceHub.roleManager, new object[] { role });
