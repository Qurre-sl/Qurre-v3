...
{
    private static readonly MethodInfo CreateSpawnMessagePayloadMethod =
        AccessTools.Method(typeof(NetworkServer), "CreateSpawnMessagePayload");
    ...
    public static SpawnMessage SpawnMessage(this NetworkIdentity identity)
    {
        ...
        var payload = (ArraySegment<byte>)CreateSpawnMessagePayloadMethod.Invoke(null, new object[] { false, identity, writer, writer2 });
