...
{
    private static readonly Action<AdminToys.AdminToyBase, Footprint> SetSpawnerFootprint =
        AccessTools.MethodDelegate<Action<AdminToys.AdminToyBase, Footprint>>(
            AccessTools.PropertySetter(typeof(AdminToys.AdminToyBase), "SpawnerFootprint"));
        ...
        float volume = 1.0F, float minDistance = 1.0F, float maxDistance = 15.0F)
    {
        ...
        Base = speakerToy;
        SetSpawnerFootprint(Base, new Footprint(Server.Host.ReferenceHub));
