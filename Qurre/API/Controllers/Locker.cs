...
{
    private static readonly AccessTools.FieldRef<MapGeneration.Distributors.Locker, AudioClip> GrantedBeepRef =
        AccessTools.FieldRefAccess<MapGeneration.Distributors.Locker, AudioClip>("_grantedBeep");

    private static readonly AccessTools.FieldRef<MapGeneration.Distributors.Locker, AudioClip> DeniedBeepRef =
        AccessTools.FieldRefAccess<MapGeneration.Distributors.Locker, AudioClip>("_deniedBeep");
    ...
    public AudioClip GrantedBeep => GrantedBeepRef(GlobalLocker);
    public AudioClip DeniedBeep => DeniedBeepRef(GlobalLocker);
