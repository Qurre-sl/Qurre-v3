...
{
    private static readonly AccessTools.FieldRef<Scp079Role, Scp079CurrentCameraSync> CurCamSyncRef =
        AccessTools.FieldRefAccess<Scp079Role, Scp079CurrentCameraSync>("_curCamSync");

    private static readonly Action<Scp079CurrentCameraSync, Scp079Camera> SetCurrentCamera =
        AccessTools.MethodDelegate<Action<Scp079CurrentCameraSync, Scp079Camera>>(
            AccessTools.PropertySetter(typeof(Scp079CurrentCameraSync), "CurrentCamera"));
    
    private static readonly Action<Scp079TierManager, int> SetAccessTierIndex =
        AccessTools.MethodDelegate<Action<Scp079TierManager, int>>(
            AccessTools.PropertySetter(typeof(Scp079TierManager), "AccessTierIndex"));
    
    private static readonly AccessTools.FieldRef<Scp079AuxManager, float[]> MaxPerTierRef =
        AccessTools.FieldRefAccess<Scp079AuxManager, float[]>("_maxPerTier");
    ...
    public Camera Camera
    {
        ...
        set => SetCurrentCamera(CurCamSyncRef(Base), value.Base);
    }
    ...
    public int Lvl
    {
        ...
        set
        {
            ...
            SetAccessTierIndex(TierManager, value - 1);
        }
    }
    ...
    public float MaxEnergy
    {
        get
        {
            ...
            return MaxPerTierRef(AuxManager)[TierManager.AccessTierIndex];
        }
        set
        {
            if (AuxManager == null || TierManager == null)
            ...
            MaxPerTierRef(AuxManager)[TierManager.AccessTierIndex] = value;
        }
    }
