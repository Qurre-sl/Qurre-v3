...
{
    private static readonly MethodInfo ServerApplyPreferenceMethod =
        AccessTools.Method(typeof(AttachmentsServerHandler), "ServerApplyPreference",
    ...
    private static void SetupFirearmAttachments(ReferenceHub referenceHub, Firearm firearm)
    {
        ...
        ServerApplyPreferenceMethod.Invoke(null, new object[] { referenceHub, firearm.ItemTypeId, attachmentsCode });
    }
}