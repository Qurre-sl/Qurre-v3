...
{
    private static readonly Action<WaveQueueState> SetWaveManagerState =
        AccessTools.MethodDelegate<Action<WaveQueueState>>(
            AccessTools.PropertySetter(typeof(WaveManager), "State"));
