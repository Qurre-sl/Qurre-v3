...
{
    private static readonly MethodInfo ChangeLevelMethod =
        AccessTools.Method(typeof(RoundRestart), "ChangeLevel", new[] { typeof(bool) });
    
    private static readonly MethodInfo RefreshConfigsMethod =
        AccessTools.Method(typeof(AttackerDamageHandler), "RefreshConfigs");
    ...
    public static bool FriendlyFire
    {
        ...
        set
        {
            ...
            RefreshConfigsMethod.Invoke(null, null);
    ...
    public static void Restart()
    {
        ...
        ChangeLevelMethod.Invoke(null, new object[] { true });
    }
