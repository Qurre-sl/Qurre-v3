...
public static class Audio
{
    ...
    private static readonly AccessTools.FieldRef<ReferenceHub> HostHubRef =
        AccessTools.StaticFieldRefAccess<ReferenceHub>(AccessTools.Field(typeof(ReferenceHub), "_hostHub"));

    /// <summary>
    ///     Audio player that plays on behalf of the host.
    /// </summary>
    public static AudioPlayerBot HostBaseAudioPlayer =>
        LocalHostAudioPlayer ??= new AudioPlayerBot(HostHubRef());
    ...
    private static readonly Action<CentralAuth.PlayerAuthenticationManager, ClientInstanceMode> SetInstanceMode =
        AccessTools.MethodDelegate<Action<CentralAuth.PlayerAuthenticationManager, ClientInstanceMode>>(
            AccessTools.PropertySetter(typeof(CentralAuth.PlayerAuthenticationManager), "InstanceMode"));
        ...
        Vector3 rotation)
    {
        ...
        SetInstanceMode(referenceHub.authManager, ClientInstanceMode.ReadyClient);
