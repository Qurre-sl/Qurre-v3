...
public class InteractShootingTargetEvent : IBaseEvent
{
    ...
    internal InteractShootingTargetEvent(Player player, ShootingTarget shootingTarget, ShootingTargetButtonType button)
    {
        Player = player;
    ...
    public ShootingTargetButtonType Button { get; set; }
    public bool Allowed { get; set; }
    public uint EventId { get; } = EventID;
}
